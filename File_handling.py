...
file = open("C:/Users/mohit/Desktop/words.txt", "rt")
...
file = open('C:/Users/mohit/Desktop/words.txt', mode='wt')

file.write("Now this has one line\n")
file.writelines(["Second Line\n", "Third Line\n"])

file.close()  # you write a line and for saving the lines you have to close the file. 
...
with open("C:/Users/mohit/Desktop/wall_1.jpg","rb") as rf :
...
os.getcwd() # Current working directories
...
The first row is known as a header 
There is no data type for the data
